...
router.get("/", (request, response) => {
    ...
    const theQuery = "SELECT FirstName, LastName, Username, MemberId, Contacts.primaryKey FROM Contacts RIGHT JOIN Members ON Contacts.MemberID_A = Members.MemberId WHERE MemberID_B = $1 AND Contacts.Verified != 1 ORDER BY Contacts.primaryKey DESC"
