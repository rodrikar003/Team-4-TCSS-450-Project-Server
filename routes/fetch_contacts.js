...
router.get("/", (request, response) => {
    ...
    const theQuery = "SELECT FirstName, LastName, Username, MemberId, Contacts.primaryKey FROM Contacts RIGHT JOIN Members ON Contacts.MemberID_B = Members.MemberId WHERE MemberID_A = $1 ORDER BY Contacts.primaryKey DESC"
